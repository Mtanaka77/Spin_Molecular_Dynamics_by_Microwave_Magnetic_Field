...
!*                                                               *
!% mpif90 -mcmodel=medium -fpic -O2 -o ay.out @spin_SMD7a.f03 -I/opt/fftw3/include -L/opt/fftw3/lib -lfftw3 &> log
...
!
      real(C_DOUBLE) e_sp0,e_c_r0,e_LJ0,t8_start
      logical  if_LJ0
!
...
!
      ...
      uu1(7)= uav
!
      call mpi_allreduce (uu1,uu2,7,mpi_real8,mpi_sum,mpi_comm_world, &
                          mpierror)
!
      wx1= uu2(1)
      wy1= uu2(2)
...
!
        write(11,771) t8,it,is,iter,Usys(is),U_Fe(is),U_O(is),conv(is), &
                 e_sp,e_c_r,e_LJ,magz(is),ds_Fe(is),ds_O(is),wtime/60.d0
