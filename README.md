...
Microwave magnetic heating by numerical simulation reaches 1,400 Celsius for 
metal oxide magnetite (sai107.791a.pdf).
...
constant magnetic field B_z0= 10^4 gauss, and the initial temperture 200 K.
